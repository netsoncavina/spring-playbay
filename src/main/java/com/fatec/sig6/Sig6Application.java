...
import com.fatec.sig6.ports.MantemCliente;
import com.fatec.sig6.ports.MantemPedido;
import com.fatec.sig6.ports.ProdutoRepository;

@SpringBootApplication
public class Sig6Application implements CommandLineRunner {
	@Autowired
	...
	public static void main(String[] args) {
		SpringApplication.run(Sig6Application.class, args);
	}
